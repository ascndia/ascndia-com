...
var getPayload_1 = require("./payload/getPayload");
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var payload, nextApp, nextHandler;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, getPayload_1.getPayloadClient)({
                    initOptions: {
                        express: app,
                        onInit: function (newPayload) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                newPayload.logger.info("Payload Admin URL: ".concat(newPayload.getAdminURL()));
                                return [2 /*return*/];
                            });
                        }); }
                    },
            ...
            case 1:
                ...
                nextApp.prepare().then(function () {
                    ...
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Next.js App URL: ".concat(process.env.PAYLOAD_PUBLIC_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });

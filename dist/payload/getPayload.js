...
var getPayloadClient = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (_a) {
        var _b, e_1;
        var _c = _a === void 0 ? {} : _a, initOptions = _c.initOptions, seed = _c.seed;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _b.client = _d.sent();
                    if (!seed) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, seed_1.seedData)(payload_1.default)];
                case 3:
                    _d.sent();
                    _d.label = 4;
                ...
                case 5:
                    ...
                    cached.promise = null;
                    throw e_1;
                case 6: return [2 /*return*/, cached.client];
            }
        });
    });
};
